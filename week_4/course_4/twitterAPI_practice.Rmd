...
set.seed(1234)
wordcloud(words = d$word, freq = d$freq, scale=c(3,0.1),min.freq = 1,
...
# 從推特上得出的文字雲與我在CNN新聞上得出的結果相似，可以得知目前所有與川普有關的言論、消息幾乎都脫離不了大法官Brett Kavanaugh
